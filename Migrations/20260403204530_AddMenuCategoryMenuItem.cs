...
{
    /// <inheritdoc />
    public partial class AddMenuCategoryMenuItem : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryMenuItem", x => new { x.CategoriesId, x.ItemsId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategoryMenuItem_MenuItems_ItemsId",
                        column: x => x.ItemsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryMenuItem_ItemsId",
